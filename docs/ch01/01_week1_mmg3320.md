...
![Shell-benefits](../img/benefits-shells.png)
...
<figure markdown="span">
  ![bluemoon cluster](../img/connect-to-remote.png){ width="800" }
...
![running-program1](../img/running-programs2.png)
