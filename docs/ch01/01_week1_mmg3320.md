...
![GUI-vs-CUI](/img/GUI-vs-CUI-min.jpg){ align=left }
...
![compute cluster](/img/compute_cluster.png){ align=left }
...
![bluemoon cluster](/img/bluemoon-logo.png){ align=left }
...
![terminal](/img/terminal.png){ align=left }


+ RStudio: an integrated development environment for R

![RStudio-Logo](/img/RStudio-Logo.png){ align=left }
...
![dashboard](/img/dashboard.png){ align=left }

4. To access the Terminal Go to <button>Clusters</button>  and click
`>_VACC Shell Access`

![terminal dashboard](/img/terminal_dashboard.png){ align=left }
...
![terminal-2](/img/terminal1.png){ align=left }


Once you open your terminal, your screen should look similar to below: 

![login](/img/login7.png){ align=left }
...
![login](/img/login2.png){ align=left }
...
![login](/img/login.png){ align=left }
...
![login](/img/login5.png){ align=center }
