---
title: "Accessing Public Experimental Data"
author: "Dr. Princess Rodriguez"
date: "2025-01-29"
output:
  beamer_presentation:
    theme: AnnArbor
...
fontsize: 12pt # Sets the base font size
---
...
<figure markdown="span">
  ![Overview](../img/overview.png){ width="600"}
</figure>
...
<figure markdown="span">
  ![Required File Inputs](../img/inputs.png){ width="600"}
</figure>
...
<figure markdown="span">
  ![FASTA format](../img/fasta.png){ width="600"}
</figure>
...
<figure markdown="span">
  ![GTF format](../img/GTF_file_example.jpg){ width="600"}
</figure>
...
+ For **finding reference data**, we will navigate the [Ensembl database](http://useast.ensembl.org/index.html). 

+ For **accessing experimental data**, we will explore the [Gene Expression Omnibus](https://www.ncbi.nlm.nih.gov/geo/) and the [Sequence Read Archive](https://www.ncbi.nlm.nih.gov/sra) repositories. 
...
<figure markdown="span">
  ![GRC logo](../img/GRC.png){ width="400"}
</figure>
...
For all other organisms there are additional Ensembl databases available through [Ensembl Genomes](http://ensemblgenomes.org/); however, they do not include viruses (NCBI does).
...
<figure markdown="span">
  ![Ensembl website](../img/ensembl_interface.png){ width="600"}
</figure>
...
<figure markdown="span">
  ![FTP Download on Ensembl](../img/download_ensembl.png){ width="600"}
</figure>
...
<figure markdown="span">
  ![Kenny et al. 2014 dataset](../img/mov10_paper.png){ width="600"}
</figure>
...
<figure markdown="span">
  ![GEO Accession](../img/mov10_accession.png){ width="600"}
</figure>
...
<figure markdown="span">
  ![GEO Page Example](../img/mov10_geo.png){ width="600"}
</figure>
...
<figure markdown="span">
  ![Raw Counts Download](../img/mov10_download.png){ width="600"}
</figure>
...
<figure markdown="span">
  ![Summary Page](../img/mov10_geo.png){ width="600"}
</figure>
...
<figure markdown="span">
  ![SRA Platforms, Samples, and Relations displayed](../img/relations.png){ width="600"}
</figure>
...
<figure markdown="span">
  ![Run Selector: Common Fields Table](../img/table.png){ width="600"}
</figure>
...
<figure markdown="span">
  ![Run Selector: Sample Display](../img/samples-found.png){ width="600"}
</figure>
...
<figure markdown="span">
  ![Understanding Run Selector](../img/two-lanes.png){ width="600"}
</figure>

Therefore, for a single sample, there will be double the amount of sequencing files to process. 

<figure markdown="span">
  ![Run Selector Take-Away](../img/more-files.png){ width="600"}
</figure>
...
6. When you are finished show me your laptop.  
